...
import LocationOnIcon from '@mui/icons-material/LocationOn';import IconButton from '@mui/material/IconButton';
  ...
  return (
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Toolbar disableGutters>
          <BloodtypeOutlinedIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} />
          <Typography
            variant="h6"
            noWrap
            component="a"
      ...
      >
        ...
        <Box sx={{ overflow: 'auto' }}>
          ...
          <Button variant="text" onClick={handleSample}>Sample</Button>
...
<Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0 }} elevation={3}>
        ...
        >
            <Copyright/>
          {/* <BottomNavigationAction label="@Copyright ©2022 "  /> */}
        </BottomNavigation>
      </Paper>
    </>
  )
